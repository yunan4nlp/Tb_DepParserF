    ...
    def get_gold_action(self, vocab):
        ...
        if self._stack_size == 0:
            ...
            if top0 == self._inst.heads[top1]:  # top1 <- top0
                gold_action.set(CODE.ARC_LEFT, vocab._rel2id[self._inst.rels[top1]])
                ...
                if have_right_child:
                    ...
                    gold_action.set(CODE.ARC_RIGHT, vocab._rel2id[self._inst.rels[top0]])
            else:  # can not arc
                gold_action.set(CODE.SHIFT, -1)
        return gold_action
